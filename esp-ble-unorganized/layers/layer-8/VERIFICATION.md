...
기록일: **2026-08-28**. [사용 방법](README.md).
...
[원시 로그와 결과](../../testing/results/b6-rejoin-8vnbdmzz/RESULT.md).
...
[이번 설치 증거](../../testing/results/b6-layer8-install-1189fty3/RESULT.md).
...
- [B6 AppKey/Publication 진단](B6_SETUP.md)
...
- [STM32 버튼·USART2 설치와 실제 관찰](../../stm32-project/integration/stm32/BUTTON_UART_TEST.md)
