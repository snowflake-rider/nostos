...
- [CubeMX IOC](../stm32-project/integration/stm32/bike_swarm_guard.ioc): PA9 TX, PA10 RX, PB6 TEST_BUTTON.
- [STM32 main.c](../stm32-project/integration/stm32/Core/Src/main.c): UART 초기화·버튼 GPIO·USB trace 연결.
- [button.c](../stm32-project/integration/stm32/MyApp/hw/button.c): PB6 정지 요청, 30ms 디바운스, 눌림 전이 처리.
- [ESP32 bridge_runtime.c](../layers/layer-8/main/bridge_runtime.c): UART1, TX17/RX18, UART·Mesh 로그.
