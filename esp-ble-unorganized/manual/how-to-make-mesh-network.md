...
- [Layer 7 firmware entry point](../layers/layer-7/main/main.c)
- [Mesh Node 구현](../layers/layer-7/main/mesh_node.c)
- [Serial command parser](../layers/layer-7/main/serial_command.c)
- [한 보드 Build/Flash/Boot workflow](../layers/layer-7/bootload.sh)
- [세 보드 Build/Flash/Boot workflow](../layers/layer-7/bootload-triplet.sh)
- [세 보드 monitor](../layers/layer-7/monitor-triplet.sh)
- [BLE Mesh 용어](../docs/03-reference/TERMS.md)
- [이전 Layer별 검증 기록](../docs/01-project/STATUS.md)
