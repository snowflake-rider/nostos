...
> [현재 배선과 설치·검증 기록](stm32/BUTTON_UART_TEST.md)을 먼저 확인하세요.
...
[STM32 SharedState](stm32/SHARED_STATE.md)는 A·B·C의 센서값을 저장·조회하는 모듈입니다. PC 테스트와 STM32 빌드는 확인했고, 실제 센서·UART 입력과 Dashboard에는 아직 연결하지 않았습니다.
