...
- [전체 ESP32 모듈 핀 정의표와 원본 이미지](../docs/03-reference/ESP32-S3-N16R8-PINOUT.md)
- [ESP32 Layer 8 실제 UART 설정 소스](../layers/layer-8/main/bridge_runtime.c)
- [STM32 초기화 소스](../stm32-project/integration/stm32/Core/Src/main.c)
