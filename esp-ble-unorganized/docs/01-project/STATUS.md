...
[전체 시작 메뉴](../../README.md) · [프로젝트 개요](OVERVIEW.md) · [학습 로드맵](../02-learning/LAYER-ROADMAP.md) · [통신 API](../../communication-module/README.md)
...
| [STM32 버튼 시험](../../stm32-project/integration/stm32/BUTTON_UART_TEST.md) | PB6 입력, USART2 송신, NUCLEO Flash, ST-LINK VCP의 `0x13` 수신 확인 | NUCLEO 외부 D1/PA2 → ESP32 GPIO18 경로와 이후 Mesh 송수신 |
...
- [STM32 버튼·USART2 실제 관찰 결과](../../stm32-project/integration/stm32/BUTTON_UART_TEST.md)
