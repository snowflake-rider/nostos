...
| 파일 | 역할 |
|---|---|
| [CMakeLists.txt](../../layers/layer-0/CMakeLists.txt) | 프로젝트 이름과 ESP-IDF 빌드 설정 |
| [main/CMakeLists.txt](../../layers/layer-0/main/CMakeLists.txt) | 컴파일할 소스와 헤더 검색 경로 지정 |
| [main/main.c](../../layers/layer-0/main/main.c) | 보드에서 실행할 실제 코드 |
| [sdkconfig.defaults](../../layers/layer-0/sdkconfig.defaults) | 프로젝트에서 정한 초기 설정값. 선택 사항 |
| [sdkconfig](../../layers/layer-0/sdkconfig) | 자동 생성되는 현재 프로젝트 설정값 |
