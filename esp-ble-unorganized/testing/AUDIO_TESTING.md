...
진행/실물 판정은 [checklist.md](checklist.md)에 기록한다. 낙상·초음파 통합 시험은 별도다.
...
```sh
sh /Users/kafka/Workspace_AI/esp-ble/testing/run_stm32_host_tests.sh
```
...
/Users/kafka/.espressif/python_env/idf5.5_py3.14_env/bin/python /Users/kafka/Workspace_AI/esp-ble/testing/codec_diag.py --seconds 600

# 지금 코덱 레지스터 읽기. 보드/코덱 reset 없음.
/Users/kafka/.espressif/python_env/idf5.5_py3.14_env/bin/python /Users/kafka/Workspace_AI/esp-ble/testing/codec_diag.py --command registers --seconds 5

# 코덱만 reset하고 SDI 명령 응답 검사. 마지막에 다시 초기화하며 소리는 내지 않는다.
/Users/kafka/.espressif/python_env/idf5.5_py3.14_env/bin/python /Users/kafka/Workspace_AI/esp-ble/testing/codec_diag.py --command sdi --seconds 5

# 청취자가 준비된 후에만: 기존 VOL=5050에서 내장 시험음 1초, 종료 후 코덱 초기화.
/Users/kafka/.espressif/python_env/idf5.5_py3.14_env/bin/python /Users/kafka/Workspace_AI/esp-ble/testing/codec_diag.py --command sine --confirm-tone --seconds 5
```
