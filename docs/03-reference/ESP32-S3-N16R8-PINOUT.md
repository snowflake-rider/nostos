> 이관 원문: `docs/03-reference/ESP32-S3-N16R8-PINOUT.md`. 현재 실행 경로는 [팀원 시작 안내](../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.

# ESP32-S3-N16R8 핀 참고 — 모듈 배치와 Pin Definitions

[프로젝트 시작 메뉴](../04-records/esp-ble-original-index.md) · [Layer 8](../layers/layer-8/README.md) · [현재 버튼/UART 시험 배선](../layers/layer-8/FAST_CHECK.md)
...
[Layer 8 bridge_runtime.c](../../code/layers/layer-8/main/bridge_runtime.c):
...
STM32의 현재 실제 송신은 USART1이며, USART2는 ST-LINK USB 진단 복사본에 사용한다. 예전 D0/D1 배선 메모를 현재 배선으로 사용하지 않는다. 관련 소스는 [STM32 main.c](../../code/firmware/stm32/Core/Src/main.c), 상세 시험 안내는 [FAST_CHECK.md](../layers/layer-8/FAST_CHECK.md)를 따른다.
