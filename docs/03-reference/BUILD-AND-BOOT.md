> 이관 원문: `docs/03-reference/BUILD-AND-BOOT.md`. 현재 실행 경로는 [팀원 시작 안내](../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.

# Build & Boot — 빌드 파일과 부팅 개념

[전체 시작 메뉴](../04-records/esp-ble-original-index.md) · [학습 순서](../02-learning/README.md)

실습을 처음 시작한다면 [프로젝트 생성과 첫 빌드](../02-learning/01-project-start.md)부터 읽는다.
...
| 파일 | 역할 |
|---|---|
| [CMakeLists.txt](../../code/layers/layer-0/CMakeLists.txt) | 프로젝트 이름과 ESP-IDF 빌드 설정 |
| [main/CMakeLists.txt](../../code/layers/layer-0/main/CMakeLists.txt) | 컴파일할 소스와 헤더 검색 경로 지정 |
| [main/main.c](../../code/layers/layer-0/main/main.c) | 보드에서 실행할 실제 코드 |
| [sdkconfig.defaults](../../code/layers/layer-0/sdkconfig.defaults) | 프로젝트에서 정한 초기 설정값. 선택 사항 |
| [sdkconfig](../../code/layers/layer-0/sdkconfig) | 자동 생성되는 현재 프로젝트 설정값 |
...
실습은 [02. Hardware Bring-up](../02-learning/02-hardware-bringup.md)에서 로그 코드 작성부터 Flash·실행 확인까지 이어서 진행한다.
...
[자세한 설명과 기존 이해 기록](../04-records/BRINGUP-NOTES.md)
