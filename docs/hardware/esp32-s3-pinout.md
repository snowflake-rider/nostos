> 이관 원문: `docs/03-reference/ESP32-S3-N16R8-PINOUT.md`. 현재 실행 경로는 [팀원 시작 안내](../getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.

# ESP32-S3-N16R8 핀 참고 — 모듈 배치와 Pin Definitions

[프로젝트 시작 메뉴](../archive/records/esp-ble-original-index.md) · [Layer 8](../../firmware/esp32/docs/layer8-background.md) · [현재 버튼/UART 시험 배선](../../firmware/esp32/docs/FAST_CHECK.md)
...
![ESP32-S3 모듈 Pin Layout, Top View](../assets/esp32-s3-pinout/module-pin-layout-top-view.png)
...
[Layer 8 bridge_runtime.c](../../firmware/esp32/main/bridge_runtime.c):
...
STM32의 현재 실제 송신은 USART1이며, USART2는 ST-LINK USB 진단 복사본에 사용한다. 예전 D0/D1 배선 메모를 현재 배선으로 사용하지 않는다. 관련 소스는 [STM32 main.c](../../firmware/stm32/Core/Src/main.c), 상세 시험 안내는 [FAST_CHECK.md](../../firmware/esp32/docs/FAST_CHECK.md)를 따른다.
...
- [Figure 3-1 — Pin Layout (Top View)](../assets/esp32-s3-pinout/module-pin-layout-top-view.png)
- [Table 3-1 — Pin Definitions, 패드 1~31](../assets/esp32-s3-pinout/pin-definitions-1.png)
- [Table 3-1 — 계속, 패드 32~41 및 각주](../assets/esp32-s3-pinout/pin-definitions-2.png)
