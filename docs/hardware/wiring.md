> 이관 원문: `settings/PIN.md`. 현재 실행 경로는 [팀원 시작 안내](../getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- [전체 ESP32 모듈 핀 정의표와 원본 이미지](esp32-s3-pinout.md)
- [ESP32 Layer 8 실제 UART 설정 소스](../../firmware/esp32/main/bridge_runtime.c)
- [STM32 초기화 소스](../../firmware/stm32/Core/Src/main.c)
- [읽기 전용 UART 진단](../../firmware/esp32/docs/UART_DIAGNOSTICS.md)
- [빠른 버튼 → Mesh 시험](../../firmware/esp32/docs/FAST_CHECK.md)
