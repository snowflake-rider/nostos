...
기존 [Layer 7 매뉴얼](how-to-make-mesh-network.md)의 C000 설정만으로 버튼·낙상 이벤트가 준비되지는 않는다.
...
상태 기록: [testing/checklist.md](../archive/imported/testing/checklist.md), 배선: [wiring.md](wiring.md).
...
과거 [B6 키 불일치 진단](../../firmware/esp32/docs/B6_SETUP.md)은 이전 시점의 기록이다.
