> 이관 원문: `stm32-project/README.md`. 현재 실행 경로는 [팀원 시작 안내](../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
A·B·C의 센서값을 STM32에 모아 두는 부분은 [SharedState 설명과 예제](../firmware/stm32/SHARED_STATE.md)를 읽으면 됩니다. 저장·조회 모듈은 준비됐고, 실제 UART 수치 수신과 화면 연결은 다음 단계입니다.

## 공용 펌웨어

세 보드가 사용하는 기준 프로젝트는 [`integration/stm32`](../..)에 있습니다.
