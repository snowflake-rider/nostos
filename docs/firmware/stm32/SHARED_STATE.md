> 이관 원문: `stm32-project/integration/stm32/SHARED_STATE.md`. 현재 실행 경로는 [팀원 시작 안내](../../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- [shared_state.h](../../../code/firmware/stm32/MyApp/service/shared_state.h): 구조체와 사용할 함수.
- [shared_state.c](../../../code/firmware/stm32/MyApp/service/shared_state.c): 값 저장·조회와 오래됨 판정.
...
이 코드는 설명용 발췌입니다. `init`과 `update`의 성공 여부까지 확인하는 [실행 가능한 예제](../../../code/firmware/stm32/host-tests/shared_state_example.c)도 있습니다.
...
[프로젝트 처음으로](../../legacy-stm32/README.md) · [통신 흐름 설명](../../legacy-stm32/integration/esp32-s3/README.md)
