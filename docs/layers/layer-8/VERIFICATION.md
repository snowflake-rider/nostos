> 이관 원문: `layers/layer-8/VERIFICATION.md`. 현재 실행 경로는 [팀원 시작 안내](../../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- [STM32 버튼·USART2 설치와 실제 관찰](../../firmware/stm32/BUTTON_UART_TEST.md)
