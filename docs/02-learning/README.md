> 이관 원문: `docs/02-learning/README.md`. 현재 실행 경로는 [팀원 시작 안내](../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- [블루투스 기본 용어](../03-reference/TERMS.md)
- [BLE 학습 Layer 순서](LAYER-ROADMAP.md)

## 참고

- [Bring-up 개요와 빌드 파일·sdkconfig 설명](../03-reference/BUILD-AND-BOOT.md)
- [이전 설명과 이해 확인 기록](../04-records/BRINGUP-NOTES.md)
- [내가 이해한 BLE 용어](../04-records/MY_UNDERSTANDING.md)
