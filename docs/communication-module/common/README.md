> 이관 원문: `communication-module/common/README.md`. 현재 실행 경로는 [팀원 시작 안내](../../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.

# Common Message Definitions

Event-driven과 Periodic이 함께 사용하는 데이터 정의를 두는 위치다. [comm_message.h](../../../code/communication-module/common/comm_message.h)에 버튼 이벤트와 Head의 평균 속도 메시지를 정의한다.
