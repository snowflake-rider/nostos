> 이관 원문: `verified/01-hardware-and-settings.md`. 현재 실행 경로는 [팀원 시작 안내](../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- [CubeMX IOC](../../code/firmware/stm32/nostos_stm32.ioc): PA9 TX, PA10 RX, PB6 TEST_BUTTON.
- [STM32 main.c](../../code/firmware/stm32/Core/Src/main.c): UART 초기화·버튼 GPIO·USB trace 연결.
- [button.c](../../code/firmware/stm32/MyApp/hw/button.c): PB6 정지 요청, 30ms 디바운스, 눌림 전이 처리.
- [ESP32 bridge_runtime.c](../../code/layers/layer-8/main/bridge_runtime.c): UART1, TX17/RX18, UART·Mesh 로그.
