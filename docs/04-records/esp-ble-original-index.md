> 이관 원문: `README.md`. 현재 실행 경로는 [팀원 시작 안내](../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
| 지금 하려는 일 | 먼저 읽을 문서 |
| --- | --- |
| 프로젝트 목표·센서 배치·결정 사항 이해 | [프로젝트 개요](../01-project/OVERVIEW.md) |
| 프로젝트 생성부터 BLE까지 순서대로 학습 | [학습 시작](../02-learning/README.md) |
...
| ESP32-S3-N16R8 GPIO·모듈 패드·UART 핀 확인 | [핀 배치와 전체 핀 정의표](../03-reference/ESP32-S3-N16R8-PINOUT.md) |
...
| 구현·실물 검증 범위와 남은 작업 확인 | [진행 상태와 검증 기록](../01-project/STATUS.md) |

**지금 통신 모듈을 개발한다면:** [프로젝트 개요](../01-project/OVERVIEW.md) → [모듈 README](../communication-module/README.md) → [Service API](../communication-module/service/README.md) 순서로 읽는다.

학습을 처음 시작한다면: [01. 프로젝트 생성·빌드](../02-learning/01-project-start.md) → [02. Flash·부팅](../02-learning/02-hardware-bringup.md) → [03. BLE Advertising](../02-learning/03-ble-advertising.md) → [Layer 로드맵](../02-learning/LAYER-ROADMAP.md) 순서로 읽는다.
...
- [빌드 파일·sdkconfig·부팅 개념](../03-reference/BUILD-AND-BOOT.md)
- [ESP32-C3 Mesh 한국어 참고 설명](../03-reference/ESP-BLE-MESH-C3.md) · [C3 Generic OnOff 예제](../examples/esp32c3/generic-onoff-node/README.md)
- [이미지 출처와 SHA-256](../03-reference/IMAGE-MANIFEST.md)
- [직접 작성한 이해·질문과 설계 기록](README.md)
- [Layer 8 설치·실물 검증 기록](../layers/layer-8/VERIFICATION.md)
- [현재 버튼 배선용 빠른 Layer 8 관찰](../layers/layer-8/FAST_CHECK.md)
- [iPhone GPS Mesh 구현 검증 기록](../superpowers/plans/2026-08-28-iphone-gps-mesh-verification.md)
...
`docs/superpowers/`는 기존 Layer 문서의 링크를 지키기 위해 경로를 유지한다. 처음부터 읽을 필요는 없으며 [기록 목록](README.md)에서 필요한 설계·계획을 찾는다.
