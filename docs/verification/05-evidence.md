> 이관 원문: `verified/05-evidence.md`. 현재 실행 경로는 [팀원 시작 안내](../getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
| 파일 | 용도 |
| --- | --- |
| [observation-gpio18-after-d6-reset-02.log](evidence/uart-periodic-test.WRLuTL/observation-gpio18-after-d6-reset-02.log) | 성공 실행: STM32 10회와 D6 UART 10회 |
| [stm32-runtime-after-gpio18.log](evidence/uart-periodic-test.WRLuTL/stm32-runtime-after-gpio18.log) | MCU RAM의 시도·성공·실패 카운터 |
| [restore-after-gpio18.log](evidence/uart-periodic-test.WRLuTL/restore-after-gpio18.log) | 원래 512KB Flash 복구·검증 |
| [d6-final-uart-diag-02.log](evidence/uart-periodic-test.WRLuTL/d6-final-uart-diag-02.log) | 복구 후 D6 재부팅·최종 준비 상태 |
| [RESULT.md](evidence/uart-periodic-test.WRLuTL/RESULT.md) | 초기 실패와 성공까지의 누적 시험 기록 |
...
| 파일 | 용도 |
| --- | --- |
| [raw.jsonl](evidence/button-mesh-test.eFmI1o/raw.jsonl) | 각 보드의 전체 관찰 로그·status·상대 시각 |
| [console.log](evidence/button-mesh-test.eFmI1o/console.log) | 대상 `0x13` 이벤트 발췌·집계 |
| [RESULT.md](evidence/button-mesh-test.eFmI1o/RESULT.md) | 사용자 세 번 누름 확인을 포함한 현장 결과 |
