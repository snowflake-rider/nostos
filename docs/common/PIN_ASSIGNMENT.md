> 이관 원문: `stm32-project/common/PIN_ASSIGNMENT.md`. 현재 실행 경로는 [팀원 시작 안내](../00-team/START.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
> [현재 배선·보드 브리지 주의사항·검증](../firmware/stm32/BUTTON_UART_TEST.md)을 따른다.
