> 이관 원문: `README.md`. 현재 실행 경로는 [팀원 시작 안내](../../getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- [Layer 8 설치·실물 검증 기록](../../../firmware/esp32/docs/VERIFICATION.md)
