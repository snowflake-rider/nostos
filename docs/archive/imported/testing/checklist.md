> 보존 원문: `esp-ble-unorganized/testing/checklist.md`. 당시 경로·명령·검증 결과이며 현재 실행 안내는 저장소 README를 따릅니다.
...
설치 증거 (원본에 포함되지 않은 참조: `results/b6-layer8-install-1189fty3/RESULT.md`).
재등록·실제 수신 증거 (원본에 포함되지 않은 참조: `results/b6-rejoin-8vnbdmzz/RESULT.md`).
