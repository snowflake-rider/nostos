> 이관 원문: `docs/superpowers/plans/2026-08-27-layer-6-symmetric-forwarding-plan.md`. 현재 실행 경로는 [팀원 시작 안내](../../../getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
