> 이관 원문: `stm32-project/docs/superpowers/specs/2026-08-28-stm32-mesh-event-bridge-design.md`. 현재 실행 경로는 [팀원 시작 안내](../../../../../getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- [message_type.h](../../../../../../libs/protocol/message_type.h): 공통 이벤트 ID의 유일한 원본. HAL에 의존하지 않으므로 STM32/ESP32/호스트 코드에서 같은 헤더를 참조한다.
- [uart_service.c](../../../../../../firmware/stm32/MyApp/service/uart_service.c): USART1으로 ID 한 바이트를 송수신한다. 현재 수신 대기 공간은 한 건이다.
- [message_router.c](../../../../../../firmware/stm32/MyApp/service/message_router.c): 로컬 이벤트는 로컬 처리 후 송신하고, 원격 이벤트는 로컬 처리만 한다.
