> 이관 원문: `docs/02-learning/01-project-start.md`. 현재 실행 경로는 [팀원 시작 안내](../../getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
참고: [빌드에 필요한 파일과 sdkconfig 살펴보기](../reference/BUILD-AND-BOOT.md) · [전체 학습 순서](README.md)
