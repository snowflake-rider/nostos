> 이관 원문: `docs/02-learning/LAYER-ROADMAP.md`. 현재 실행 경로는 [팀원 시작 안내](../../getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.

# ESP32-S3 BLE 학습 Layer Roadmap

[전체 시작 메뉴](../records/esp-ble-original-index.md) · [기초 학습 순서](README.md) · [진행 상태와 검증 기록](../project/STATUS.md)

이 문서는 `layers/`의 **학습 순서와 단계별 통과 기준**이다. 아래 기준은 목표이지 PASS 결과가 아니다. 실제 완료 범위·날짜·보드별 로그는 [STATUS](../project/STATUS.md)에 모은다.
...
| [8](../../../firmware/esp32/docs/layer8-background.md) | STM32 UART ↔ Mesh 이벤트 | UART RX → C001 송신 → 상대 Mesh RX → UART TX, 별도로 상대 STM32 수신/출력 확인 |
...
- [Layer 8 STM32 UART와 Mesh 이벤트 전송](../../../firmware/esp32/docs/layer8-background.md)
- [ESP32-C3 Generic OnOff 예제](../../../experiments/examples/esp32c3/generic-onoff-node/README.md)
- [ESP-BLE-MESH 한국어 설명](../reference/ESP-BLE-MESH-C3.md)
- [BLE Mesh 학습 용어](../../architecture/glossary.md)
- [내가 이해한 BLE Mesh 용어](../records/MY_UNDERSTANDING.md)
