> 이관 원문: `communication-module/event-driven/README.md`. 현재 실행 경로는 [팀원 시작 안내](../../../docs/getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- [comm_event_queue.h](comm_event_queue.h): 큐 자료형과 공개 API.
- [comm_event_queue.c](comm_event_queue.c): 8칸 ring buffer 구현.
- [공통 메시지](../common/comm_message.h): 이벤트 종류와 데이터 정의.
- [사용 예제](examples/main.c): BUSY 때 보관하고 접수 후 제거하는 흐름.
- [테스트](tests/test_event_queue.c): FIFO, 용량 초과, wraparound, 값 복사, 반복 이벤트, NULL 인자, 재초기화, 독립 큐, 1,000회 반복 검증.
