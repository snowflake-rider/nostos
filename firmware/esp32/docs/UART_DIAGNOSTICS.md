> 이관 원문: `layers/layer-8/UART_DIAGNOSTICS.md`. 현재 실행 경로는 [팀원 시작 안내](../../../docs/getting-started/README.md)를 따른다. 아래의 과거 명칭·명령·검증 범위는 기록 당시 내용이다.
...
- 구현: [uart_diag.c](../main/uart_diag.c), 기존 `bridge_runtime_log_status()`에서 호출.
