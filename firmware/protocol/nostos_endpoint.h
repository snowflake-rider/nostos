...
typedef struct {
    ...
    bool (*audio_playing)(void *context);
    bool (*audio_stop)(void *context);
    bool (*audio_play)(void *context, const nostos_message_t *message);
...
typedef struct {
    ...
    uint32_t dropped_busy_buttons;
    uint32_t stop_preemptions;
    uint32_t fall_preemptions;
    uint32_t audio_failures;
} nostos_endpoint_t;
