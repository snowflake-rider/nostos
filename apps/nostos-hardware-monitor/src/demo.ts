...
export function createDemoSnapshot(tick: number): TelemetrySnapshot {
  ...
  return {
    ...
    transport: {
      ...
      protocolRejected: 0,
      protocolOverflows: 0,
      protocolStateUpdates: 0,
      protocolPaceRequests: 0,
      protocolStopRequests: 0,
      protocolStopAcks: 0,
      protocolStopAckMatches: 0,
      protocolStopAckIgnored: 0,
      protocolTransmitted: 0,
      protocolTransmitFailures: 0,
      protocolLastResult: 0,
    },
    outputs: {
      audioStatus: 0,
      audioPlaying: false,
