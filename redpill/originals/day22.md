...
출처: https://app.notion.com/8aa2ae7008718335bc5f8192412db5f7
...
typedef void (*TimerExpiredCallback)(unsigned int timer_id);
...
int main(void)
{
    ...
    InitTimerScheduler(ReportExpiredTimer);
...
static void SetTimer(unsigned int id, unsigned int ms)
{
    ...
    Timer *prev_timer = NULL, *next_timer = scheduler.head;
...
static void Tick(void)
{
    ...
    while ((scheduler.head != NULL) && (scheduler.head->dt == 0))
    {
        ...
        Timer *expired_timer = scheduler.head;
