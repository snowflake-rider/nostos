/* 김현수 제출 코드 기반. 원문: originals/day14.md */
#include "hexdump.h"
...
int rp14_demo(void)
{
    ...
    const rp14_SensorData sensor = {.hex_num = 0x12345678, .sensor_name = "Sensor A", .reading = 3.14f};

    rp14_hexdump("String Dump", my_text, sizeof(my_text));
    rp14_hexdump("Struct Dump", &sensor, sizeof(sensor));
